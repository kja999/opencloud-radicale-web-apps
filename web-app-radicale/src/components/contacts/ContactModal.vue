    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
      ...
      <form @submit.prevent="save" class="space-y-4">
        <div>
          ...
          <input v-model="form.fn" type="text" class="w-full border rounded px-3 py-2" required />
        </div>
        ...
        <div>
          ...
          <button type="button" @click="addEmail" class="text-sm text-primary-500">+ Add email</button>
        </div>
        ...
        <div>
          ...
          <button type="button" @click="addTel" class="text-sm text-primary-500">+ Add phone</button>
        </div>
